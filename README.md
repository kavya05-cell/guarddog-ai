...
The repository is being developed from the supplied GuardDog AI technical project specification. See `docs/project-specification.md` and `docs/pre-implementation-specification.md` for the captured requirements and pre-implementation documentation.
